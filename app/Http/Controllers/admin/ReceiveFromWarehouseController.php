...
class ReceiveFromWarehouseController extends Controller
{
    public function index()
    {
        ...
        return view('admin.receiveFromWarehouse.index')->with(compact('title','allIssuedGoods'));
    }
    ...
    public function view($senderOrderId)
    {
        ...
        return view('admin.receiveFromWarehouse.view')->with(compact('title','bookedOrder','senderInfo','receiverInfo'));
    }

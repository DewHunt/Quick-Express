...
class WarehouseIssuedGoodsController extends Controller
{
    public function index()
    {
        $title = "All Issued Goods";
        ...
        return view('admin.warehouseIssuedGoods.index')->with(compact('title','allIssuedGoods'));
    }

    public function view($senderOrderId)
    {
        $title = "View Issued Goods Details";
        ...
        return view('admin.warehouseIssuedGoods.view')->with(compact('title','bookedOrder','senderInfo','receiverInfo'));
    }

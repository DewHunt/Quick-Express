				...
				<div class="col-lg-3 col-sm-6">
					<div class="recent-news-widget footer-widget mrg-btm-30">
						...
						<div class="row">
							<div class="col-lg-4 col-sm-3">
								<div class="footer-img">
									<a href="blog-detail.html" title="blog"><img src="{{ asset('public/frontend/asset') }}/images/footer/recent-news-01.jpg" class="img-fluid" alt="blog"></a>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-lg-4 col-sm-3">
								<div class="footer-img">
									<a href="blog-detail.html" title="link"><img src="{{ asset('public/frontend/asset') }}/images/footer/recent-news-02.jpg" class="img-fluid" alt="blog"></a>
								</div>
							</div>
							<div class="col-lg-8 col-sm-9">
								<div class="recent-news-footer">

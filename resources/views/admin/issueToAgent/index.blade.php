                    		...
                    		<tr class="row_{{ $issuedGoods->id }}">
                    			...
                    			<td>
                                    <span class="switchery-demo m-b-30" onclick="statusChange({{ $issuedGoods->id }})">
                                        <input type="checkbox" {{ $issuedGoods->receiver_issue_status == 1 ? 'checked' : '' }} class="js-switch" data-color="#00c292" data-switchery="true" style="display: none;">
                                    </span>
                    			</td>
                    			<td>
                                    @php
    ...
    <script>                
        ...
        function statusChange(bookedOrderId) {
            $.ajax({
                ...
                type: "post",
                url: "{{ route('issueToAgent.issueToAgentStatus') }}",

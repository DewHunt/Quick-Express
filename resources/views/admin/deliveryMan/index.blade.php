...
@section('card_body')
    <div class="card-body">
        ...
        <div class="table-responsive">
            ...
            <table id="dataTable" class="table table-bordered table-striped"  name="deliveryMan">
                <thead>
                    <tr>
                        <th width="20px">SL</th>
                ...
                <tbody id="">
                	...
                	@foreach ($deliveryMen as $deliveryMan)
                		<tr class="row_{{ $deliveryMan->id }}">
                			...
                			<td>
                    			@php
                    				echo \App\Link::action($deliveryMan->id);
                    			@endphp                				
                			</td>
                		</tr>
                	@endforeach
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dataTable tbody').on( 'click', 'i.fa-trash', function () {
                ...
                deliveryManId = $(this).parent().data('id');
                var tableRow = this;
                swal({   
                    title: "Are you sure?",   
        ...
        function statusChange(deliveryManId) {
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },

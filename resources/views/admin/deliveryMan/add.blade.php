        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group {{ $errors->has('name') ? ' has-danger' : '' }}">
                    <input type="text" class="form-control" placeholder="Delivery Man Name" name="name" value="{{ old('name') }}" required>
                    @if ($errors->has('name'))
            ...
            <div class="col-md-6"> 
                <div class="form-group {{ $errors->has('area') ? ' has-danger' : '' }}">
                    ...
                    <div class="form-group {{ $errors->has('district') ? ' has-danger' : '' }}">
                        <select class="form-control select2" name="area[]" placeholder="Select Preffered Areas" multiple required>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group {{ $errors->has('address') ? ' has-danger' : '' }}">
                    <textarea class="form-control" rows="5" placeholder="Delivery Man Address" name="address"></textarea>

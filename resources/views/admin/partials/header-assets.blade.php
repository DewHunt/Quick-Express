...
<link href="{{ asset('public/admin-elite/assets/node_modules/icheck/skins/all.css') }}" rel="stylesheet">

<!-- Custom CSS -->
<link href="{{ asset('/public/admin-elite/dist/css/style.css') }}" rel="stylesheet">
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">

<link href="{{ asset('public/admin-elite/dist/css/pages/form-icheck.css') }}" rel="stylesheet">
